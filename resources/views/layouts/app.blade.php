...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>DOLE - RO8 | GIP Monitoring System</title>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="app-search d-none d-lg-block">
                            <div class="position-relative">
                                <h3 class="form-control">GIP Monitoring System</h3>
                            </div>
                        </div>
                    </div>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            {{-- @if (Auth::user()->is_admin == 1)
                                <li>
                                    <a href="#" class=" waves-effect"><span class="badge bg-warning float-end"></span>
                            ...
                            <li>
                                <a href="{{ route('home') }}" class=" waves-effect"><span class="badge bg-warning float-end"></span>
                                    <i class="ri-calendar-2-line"></i>
                                    <span>DASHBOARD</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('applicant.create') }}" class=" waves-effect"><span class="badge bg-warning float-end"></span>
                                    <i class="ri-calendar-2-line"></i>
                                    <span>REGISTER</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('applicant.list') }}" class=" waves-effect"><span class="badge bg-warning float-end"></span>
                                    <i class="ri-calendar-2-line"></i>
                                    <span>GIP APPLICANTS</span>
                                </a>
                            </li>
